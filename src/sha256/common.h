#ifndef SUBMODULES_LIBCRYPTO_SRC_HASH_SHA256_COMMON_H_
#define SUBMODULES_LIBCRYPTO_SRC_HASH_SHA256_COMMON_H_
...
#endif /* SUBMODULES_LIBCRYPTO_SRC_HASH_SHA256_COMMON_H_ */
